  ...
  return (
    <div className='w-[95%] max-w-[1400px] mx-auto my-12'>
        ...
        {!loading && !error && (
          <>
            <div className="overflow-x-auto">
              <table className="w-full text-sm rounded-[8px] table-auto border border-[#E5E5E5] min-w-[700px]">
                <thead>
                  ...
                  {paginatedParcels.map((parcel) => (
                    <tr key={parcel.id} className="border-b border-[#E5E5E5]">
                      ...
                      <td className="py-2 px-4">
                        <span className={`py-1 px-2.5 rounded-[14px] text-sm ${checkStatus(parcel.status)}`}>
                          {parcel.status}
                        </span>
                      </td>
      ...
      {showPopup && selectedParcel && (
        <div className="fixed inset-0 bg-[#0a0a0a9a] flex justify-center items-center z-50">
          <div className="bg-white w-[90%] max-w-md rounded-xl p-6 shadow-xl">
            ...
            <label className="block mb-4">
              ...
              <input type="date" className="block w-full border border-[#d4d4d4cb] p-3 mt-1 mb-3 rounded-md" />
            </label>
