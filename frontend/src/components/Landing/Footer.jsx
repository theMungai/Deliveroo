...
const Footer = () => {
    const addresses = [
        {label: "123 Jogoo Road, Nairobi", icon : <FontAwesomeIcon icon={faCity} />},
        {label: "+254 795 482 911", icon : <FontAwesomeIcon icon={faPhone} />},
        {label: "deliveroo@gmail.com", icon : <FontAwesomeIcon icon={faEnvelope} />},
    ]
    ...
    const quickLink = quickLinks.map((item) => (
        <li key={item} className="text-[14px] text-[#FFFFFFB8] hover:text-[#73C322B8] hover:underline cursor-pointer mb-2">{item.label}</li>
    ))
      ...
      <div className="bg-[#09090B]">
        <div className="flex justify-between text-white  px-[100px] py-[50px] w-full">
          ...
          <div className="justify-center">
            <p className="font-[500] text-[20px] mb-2.5 text-[#73C322] ">Quick Links</p>
            <ul>{quickLink}</ul>
          </div>
          ...
          <div className="relative">
            ...
            <button className="bg-[#73C322] text-white mt-5 py-2 px-5 rounded-[6px] flex items-center gap-x-2.5 absolute right-0 cursor-pointer group">
              Start Now
              <FontAwesomeIcon
