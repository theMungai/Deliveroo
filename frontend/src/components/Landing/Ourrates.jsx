...
function Rate({category, price, weight}){
    return(
        <div className='bg-white rounded-[10px] shadow hover:border-2 hover:border-[#73C322] p-8 basis-1/3'>
            ...
            <h1 className='font-[900] text-2xl mb-4'>Ksh.{price}<span className='font-[500] text-[16px]'>/parcel</span></h1>
            ...
            <button className='border border-[#73C322] text-[#989797] font-bold rounded-[8px] py-2.5 w-full hover:text-white hover:bg-[#73C322] cursor-pointer'>Choose plan</button>
...
const Ourrates = () => {
  return (
    <div className='py-[105px] bg-[#ECECEE]'>
        <h1 className='text-[28px] font-[700] mb-3 text-center'>Our Rates</h1>
        <p className='font-[500] text-[16px] mb-12 text-center'>Transparent and competitive pricing for all your needs</p>
