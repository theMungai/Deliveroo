...
const OrderForm = () => {
  return (
    <div className="rounded-[10px] bg-white border-[0.5px] border-[#818181] w-[55%] mx-auto my-5 px-10 py-6">
      ...
      <form action="">
        <div className="mb-8">
          <label htmlFor="recipient" className="">
            ...
            Recipient Name
            <input
              className="block w-full bg-[#F9F9FA] border-[0.5px] border-[#818181] px-2.5 py-3 rounded-[8px] outline-0 mt-2"
              type="text"
              id="recipient"
        ...
        <div className="w-full border-[0.5px] border-[#818181] rounded-[8px] p-[18px] mb-5">
