...
export default function ShippingDetails() {
  ...
  const routeUpdates = [
    {
      status: "Update",
      detail: "Left Mountain View Facility",
      date: "2024-07-29T10:00:00Z",
    },
    {
      status: "Update",
      detail: "Arrived at San Jose sorting center",
          ...
          {isCancelModalOpen && (
            <ModalOverlay onClose={() => setCancelModalOpen(false)}>
              ...
              >
                ...
                <p className="mb-4 text-gray-700">
                  Are you sure? Once you cancel this order, an email will be
                  sent to you to confirm cancellation.
                </p>
